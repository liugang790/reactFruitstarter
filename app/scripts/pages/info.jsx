...
class Info extends React.Component {
    ...
    render() {
        let orderList = null;
              if (this.state.orders.unfinished) {
                orderList = this.state.orders.unfinished.map((order) => {
                  let foodList = null;
                  if (order.detail) {
                ...
                return  <div className="info_order">
                          ...
                          <div className="info_sure">
                               <span className="cancle" onClick={this.canceledOrder.bind(this, order)}>取消订单</span>
                               <span className="info_pay sure_btn" onClick={this.payOrder.bind(this, order)}>付款</span>
                          </div>
                      </div>
                });
              }
